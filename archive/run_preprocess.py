...
def read_option():
    ...
    parser.add_argument('--max_note_len', help='max length of clinical note', type=int, default=5000) #mimic3 or mimic4
...
if __name__ == '__main__':
    ...
    from_saved = False
    data_path = 'data'
    dataset = args.dataset  # mimic3, eicu, or mimic4
    ...
    save_data(train_path, train_code_x, train_visit_lens, train_codes_y, train_hf_y,train_diabetes_y, train_divided, train_neighbors)
    print('\tsaving valid data')
    save_data(valid_path, valid_code_x, valid_visit_lens, valid_codes_y, valid_hf_y,valid_diabetes_y, valid_divided, valid_neighbors)
    print('\tsaving test data')
    save_data(test_path, test_code_x, test_visit_lens, test_codes_y, test_hf_y,test_diabetes_y, test_divided, test_neighbors)
