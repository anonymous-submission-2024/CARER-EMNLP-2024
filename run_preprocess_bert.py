...
if __name__ == '__main__':
    ...
    train_hypertension_y = build_heart_failure_y('49', train_codes_y, code_map)
    print('building valid hypertension labels ...')
    valid_hypertension_y = build_heart_failure_y('49', valid_codes_y, code_map)
    print('building test hypertension labels ...')
    test_hypertension_y = build_heart_failure_y('49', test_codes_y, code_map)
